...
const SlopeChart = ({ data })=>{
    console.log('SlopeChart received data:', data);
    ...
    countryMap.forEach((value, key)=>{
        if (value.gdp2000 !== undefined && value.gdp2023 !== undefined && value.gdp2000 >= 0 && value.gdp2023 >= 0) {
            const growth = (value.gdp2023 - value.gdp2000) / value.gdp2000 * 100;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "max-w-5xl mx-auto p-4 font-sans text-gray-900 bg-white shadow-lg rounded-lg",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                width: width,
                height: height,
                className: "bg-gray-50 rounded-md shadow-inner",
                children: [
                    ...
                    countryGDPs.map(({ country, gdp2000, gdp2023, growth, color })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("g", {
                            className: "group",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("line", {
                                    x1: xScale(2000),
                                    ...
                                    strokeWidth: 3,
                                    strokeOpacity: 0.9,
                                    className: "group-hover:stroke-2 group-hover:stroke-opacity-100 transition-all duration-300"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/ui/SlopeChart.tsx",
                                    lineNumber: 135,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("text", {
                                    x: xScale(2023) + 35,
                                    y: (yScale(gdp2000) + yScale(gdp2023)) / 2,
                                    fill: color,
                                    fontSize: 14,
                                    fontWeight: "bold",
...
"[project]/src/components/ui/GDPDataTable.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const formatGDP = (gdp)=>{
    return new Intl.NumberFormat('en-US').format(gdp);
};
const GDPDataTable = ({ data })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "mt-8 overflow-x-auto",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                className: "text-xl font-semibold mb-4",
                children: "GDP Data (USD)"
            }, void 0, false, {
                fileName: "[project]/src/components/ui/GDPDataTable.tsx",
                lineNumber: 22,
                columnNumber: 7
            }, this),
...
_c = GDPDataTable;
const __TURBOPACK__default__export__ = GDPDataTable;
var _c;
__turbopack_context__.k.register(_c, "GDPDataTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$GDPDataTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/GDPDataTable.tsx [app-client] (ecmascript)");
;
...
function Home() {
    _s();
    const [data, setData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(parseCSV(csvData));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (data.length > 0) {
                ...
                console.log('Selected countries at filtering:', selectedCountries);
                // Log unique years in data
                const uniqueYears = Array.from(new Set(data.map({
                    "Home.useEffect.uniqueYears": (d)=>d.year
                }["Home.useEffect.uniqueYears"]))).sort();
                console.log('Unique years in data:', uniqueYears);
                // Normalize selected countries for case-insensitive matching
                const normalizedSelected = selectedCountries.map({
                    "Home.useEffect.normalizedSelected": (c)=>c.trim().toLowerCase()
                }["Home.useEffect.normalizedSelected"]);
                // Log all year values in data
                console.log('All year values in data:', data.map({
                    "Home.useEffect": (d)=>d.year
                }["Home.useEffect"]));
                // First filter by selected countries and years with normalized matching
                const filtered = data.filter({
                    "Home.useEffect.filtered": (d)=>normalizedSelected.includes(d.country.trim().toLowerCase()) && (d.year === 2000 || d.year === 2023)
                }["Home.useEffect.filtered"]);
                console.log('Filtered data length:', filtered.length);
                console.log('Filtered data:', filtered);
                if (filtered.length === 0) {
                    console.warn('No data matched the filter criteria.');
                }
                // Group by country and only keep countries with both years
                const groupedByCountry = filtered.reduce({
                    "Home.useEffect.groupedByCountry": (acc, item)=>{
                        if (!acc[item.country]) {
                            acc[item.country] = [];
                        }
                ...
                }["Home.useEffect.groupedByCountry"], {});
                console.log('Grouped by country keys:', Object.keys(groupedByCountry));
                Object.entries(groupedByCountry).forEach({
                    "Home.useEffect": ([country, items])=>{
                        console.log(`Country: ${country}, data count: ${items.length}`);
                    }
                }["Home.useEffect"]);
                console.log('Grouped by country:', groupedByCountry);
                // Filter out countries without both years (changed to at least one year for testing)
                const completeData = Object.values(groupedByCountry).filter({
                    "Home.useEffect.completeData": (items)=>{
                        const hasAtLeastOneYear = items.length >= 1;
                        if (!hasAtLeastOneYear) {
                            console.log(`Removing ${items[0]?.country} - missing data`);
                        }
                        return hasAtLeastOneYear;
                    }
                }["Home.useEffect.completeData"]).flat();
                console.log('Final filtered data length:', completeData.length);
                console.log('Final filtered data:', completeData);
    ...
    const countryOptions = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "Home.useMemo[countryOptions]": ()=>{
            const options = Array.from(new Set(data.map({
                "Home.useMemo[countryOptions].options": (d)=>d.country
            }["Home.useMemo[countryOptions].options"]))).sort();
            ...
            const missing = selectedCountries.filter({
                "Home.useMemo[countryOptions].missing": (c)=>!options.includes(c)
            }["Home.useMemo[countryOptions].missing"]);
            if (missing.length > 0) {
                console.warn('Selected countries not in options:', missing);
            }
            return options;
        }
    }["Home.useMemo[countryOptions]"], [
    ...
    const handleCountryChange = (e)=>{
        ...
        if (selected.length > 5) {
            ...
            selected.splice(0, selected.length - 5);
        }
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "Home.useEffect": ()=>{
            ...
            console.log('Filtered data passed to SlopeChart:', filteredData);
        }
    }["Home.useEffect"], [
        selectedCountries,
        filteredData
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            className: "min-h-screen bg-white text-gray-900 font-sans p-8 flex items-center justify-center",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                        ...
                        children: "Select up to 5 countries (hold Ctrl/Cmd to select multiple):"
                    }, void 0, false, {
                        fileName: "[project]/src/app/page.tsx",
                        lineNumber: 459,
                        columnNumber: 9
            ...
            filteredData.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$GDPDataTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                data: filteredData
            }, void 0, false, {
                fileName: "[project]/src/app/page.tsx",
                lineNumber: 479,
...
_s(Home, "sq7QlEShf90nvALqSP1c/tjwmHg=");
_c = Home;
var _c;
...
//# sourceMappingURL=_b1ac2a17._.js.map